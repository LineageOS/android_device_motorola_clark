...
LOCAL_SRC_FILES := proprietary/framework/$jarname
...
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := proprietary/app/$apkmodulename/$apkname
...
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES := proprietary/priv-app/$privmodulename/$privapkname
LOCAL_CERTIFICATE := $signature
LOCAL_MODULE_CLASS := APPS
...
LOCAL_MODULE_OWNER := $VENDOR
LOCAL_MODULE_TAGS := optional
LOCAL_SRC_FILES_64 := proprietary/vendor/lib64/$vendorlibname
LOCAL_SRC_FILES_32 := proprietary/vendor/lib/$vendorlibname
